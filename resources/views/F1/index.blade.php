    ...
    <main id="main" class="main">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12">
                ...
                <button type="button" class="btn btn-primary w-100" data-bs-toggle="modal"
                    ...
                    style="background-image: url('{{ asset('assets/img/fan1.jpg') }}'); background-size: cover; height: 200px;">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <!-- Button to trigger the modal -->
                <button type="button" class="btn btn-primary w-100" data-bs-toggle="modal"
                    data-bs-target="#financialPlanningModal"
                    style="background-image: url('{{ asset('assets/img/budget.jpg') }}'); background-size: cover; height: 200px;">
        ...
        <div class="row mt-3">
            <div class="col-lg-4 col-md-6 col-sm-12">
                <!-- Button to trigger the modal -->
                <button type="button" class="btn btn-primary w-100" data-bs-toggle="modal"
                    data-bs-target="#cashManagementModal"
                    style="background-image: url('{{ asset('assets/img/finance_1dash.jpg') }}'); background-size: cover; height: 200px;">
                    Cash Management
                </button>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12">
                <!-- Button to trigger the modal -->
                <button type="button" class="btn btn-primary w-100" data-bs-toggle="modal"
                    data-bs-target="#investmentsReportModal"
                    style="background-image: url('{{ asset('assets/img/forecast.jpg') }}'); background-size: cover; height: 200px;">
                    Investments Report
                </button>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12">
                <!-- Button to trigger the modal -->
                <button type="button" class="btn btn-primary w-100" data-bs-toggle="modal"
                    data-bs-target="#fixedAssetReportsModal"
                    style="background-image: url('{{ asset('assets/img/calculate.jpg') }}'); background-size: cover; height: 200px;">
                    Fixed Asset Reports
                </button>
            </div>
        </div>
        ...
        <!-- Modal -->
        <div class="modal fade" id="cashManagementModal" tabindex="-1" aria-labelledby="cashManagementModalLabel"
            aria-hidden="true">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ps-3">
                                                    <h6>{{ $salesCount }}</h6>
                                                    <span
                                                        class="text-success small pt-1 fw-bold">{{ $salesPercentage }}</span>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ps-3">
                                                    <h6>{{ $revenueAmount }}</h6>
                                                    <span
                                                        class="text-success small pt-1 fw-bold">{{ $revenuePercentage }}</span>
                                                    <span class="text-muted small pt-2 ps-1">increase</span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ps-3">
                                                    ...
                                                    <span
                                                        class="text-danger small pt-1 fw-bold">{{ $customersPercentage }}</span>
        ...
        <!-- Modal -->
        <div class="modal fade" id="investmentsReportModal" tabindex="-1"
            aria-labelledby="investmentsReportModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal fade" id="financialPlanningModal" tabindex="-1"
            aria-labelledby="financialPlanningModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ route('budget-plans.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="target_expense"
                                    name="target_expense">
                            </div>
                            <div class="mb-3">
        ...
        <!-- Modal for creating a budget plan -->
        <div class="modal fade" id="financialPlanningModal1" tabindex="-1"
            aria-labelledby="financialPlanningModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="financialPlanningModalLabel">Create Planning</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <!-- Form for adding financial planning -->
                        <form action="{{ route('planrequest') }}" method="POST">
                            @csrf
                            <div class="mb-3">
                                <label for="title" class="col-form-label">Title:</label>
                                <input type="text" class="form-control" id="title" name="title"
                                    placeholder="ex.Stock Investment">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="submitted" class="col-form-label">Submitted by:</label>
                                <input type="text" class="form-control" id="submitted" name="submitted_by"
                                    placeholder="ex. Juan">
                            </div>
                                            ...
                                            <tbody>
                                                @foreach ($approve as $row)
                                                    <tr class="text-center">
                                                        ...
                                                        <td>{{ optional(json_decode($row->comment))->comment ?? 'Waiting' }}</td>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", () => {
                ...
                const seriesData = paymentsData.map((amount, index) => [new Date(paymentsDates[index]).getTime(),
                    amount
                ]);
                ...
                if (fixedAssetTrend === "Going Down") {
                    descriptionInput.value =
                        "Fixed Assets are in a dangerous phase we should track our revenue and expenses in order to stop the chart going down";
                } else {
                    descriptionInput.value = "";
                }
            });
