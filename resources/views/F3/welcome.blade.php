      ...
      <div class="row">
        ...
        <div class="col-lg-6 mt-4" data-aos="zoom-in" data-aos-delay="400">
          <div class="member d-flex align-items-start">
            <div class="pic"><img src="{{ asset('assets/img/lr01.png') }}" class="img-fluid" alt=""></div>
            <div class="member-info">
              <h4>Lovely Romero</h4>
              <span>Team leader</span>
              <p>Leading our team with strategic vision and a commitment to excellence.</p>
              <div class="social">
        ...
        <div class="col-lg-6 mt-4" data-aos="zoom-in" data-aos-delay="400">
          <div class="member d-flex align-items-start">
            <div class="pic"><img src="{{ asset('assets/img/lujo01.png') }}" class="img-fluid" alt=""></div>
            <div class="member-info">
              <h4>Lufredo, Johnrey F.</h4>
              <span>Leader Programmer</span>
              <p>"Driving technical brilliance with coding expertise and problem-solving skills.</p>
              <div class="social">
        ...
        <div class="col-lg-6 mt-4" data-aos="zoom-in" data-aos-delay="400">
          <div class="member d-flex align-items-start">
            <div class="pic"><img src="{{ asset('assets/img/rema01.png') }}" class="img-fluid" alt=""></div>
            <div class="member-info">
              <h4>Reas, Marklester A.</h4>
              <span>System Analyst</span>
              <p>"Ensuring seamless system integration and functionality through meticulous analysis."</p>
              <div class="social">
        ...
        <div class="col-lg-6 mt-4" data-aos="zoom-in" data-aos-delay="400">
          <div class="member d-flex align-items-start">
            <div class="pic"><img src="{{ asset('assets/img/pada01.png') }}" class="img-fluid" alt=""></div>
            <div class="member-info">
              <h4>Pajares, Dante Jr. M.</h4>
              <span>Document Specialist</span>
              <p>"Crafting and organizing comprehensive project documentation for clarity and transparency."</p>
              <div class="social">
                <a href=""><i class="ri-twitter-fill"></i></a>
                <a href=""><i class="ri-facebook-fill"></i></a>
                <a href=""><i class="ri-instagram-fill"></i></a>
        ...
        <div class="col-lg-6 mt-4" data-aos="zoom-in" data-aos-delay="400">
          <div class="member d-flex align-items-start">
            <div class="pic"><img src="{{ asset('assets/img/esne01.png') }}" class="img-fluid" alt=""></div>
            <div class="member-info">
              <h4>Estrella, Nestor S.</h4>
              <span>Business Analyst</span>
              <p>"Providing strategic insights and guiding decision-making for project success."</p>
              <div class="social">
                <a href=""><i class="ri-twitter-fill"></i></a>
                <a href=""><i class="ri-facebook-fill"></i></a>
                <a href=""><i class="ri-instagram-fill"></i></a>
