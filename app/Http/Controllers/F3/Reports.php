...
class Reports extends Controller
{
    ...
    function taxfin() { return view('taxandfin');}function creman() { return view('creditmanagement');}
    ...
    function fixass() {
        ...
        return view('fixedasset', compact('random_data'));
...
$lastNames = array_map('trim', explode("\n", File::get(storage_path('app/lname.txt'))));
    ...
    for ($i = 0; $i < 25; $i++) {
     ...
     return view('bank')->with('data', $data);
}
